...
namespace IIS.BazanosSava
{
    ...
    public class Еда : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.BazanosSava.Продукты fПродукты;
        ...
        [PropertyStorage(new string[] {
                "Продукты"})]
        [NotNull()]
        public virtual IIS.BazanosSava.Продукты Продукты
        {
            get
            {
                ...
                IIS.BazanosSava.Продукты result = this.fПродукты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЕдаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдаE", typeof(IIS.BazanosSava.Еда));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЕда : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.BazanosSava.DetailArrayOfЕда members)

        // *** End programmer edit section *** (IIS.BazanosSava.DetailArrayOfЕда members)
        ...
        /// </summary>
        public DetailArrayOfЕда(IIS.BazanosSava.Заказ fЗаказ) : 
                base(typeof(Еда), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.BazanosSava.Еда this[int index]
        {
            get
            {
                return ((IIS.BazanosSava.Еда)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.BazanosSava.Еда dataobject)
        {
